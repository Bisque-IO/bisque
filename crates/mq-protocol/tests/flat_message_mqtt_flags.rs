...
fn test_mqtt_flags_dont_affect_value() {
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"my-payload"))
        .timestamp(5000)
        .retain(true)
        .no_local(true)
        .utf8_payload(true)
...
fn test_mqtt_flags_with_key() {
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"value"))
        .timestamp(1000)
        .key(Bytes::from_static(b"partition-key"))
        .retain(true)
        .build();
    let flat = FlatMessage::new(msg).unwrap();
...
fn test_mqtt_flags_with_routing_key() {
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"sensor-data"))
        .timestamp(1000)
...
fn test_mqtt_flags_with_reply_to_and_correlation_id() {
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"request"))
        ...
        .correlation_id(Bytes::from_static(b"req-12345"))
        .no_local(true)
        .utf8_payload(true)
        .build();
    let flat = FlatMessage::new(msg).unwrap();
...
fn test_existing_flags_preserved_with_mqtt_flags() {
    ...
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"full"))
        .timestamp(9999)
        .key(Bytes::from_static(b"k"))
        .routing_key(Bytes::from_static(b"rk"))
        .reply_to(Bytes::from_static(b"rt"))
        .correlation_id(Bytes::from_static(b"ci"))
        .ttl(1000)
        .delay(2000)
        .retain(true)
        .no_local(true)
...
fn test_publisher_id_with_all_optional_fields() {
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"full-payload"))
        .timestamp(9999)
        .key(Bytes::from_static(b"pk"))
        .routing_key(Bytes::from_static(b"a/b/c"))
        .reply_to(Bytes::from_static(b"reply"))
        .correlation_id(Bytes::from_static(b"corr"))
        .ttl(60000)
        .delay(5000)
        .publisher_id(999)
        .header(Bytes::from_static(b"h1"), Bytes::from_static(b"v1"))
        .header(Bytes::from_static(b"h2"), Bytes::from_static(b"v2"))
        .header(Bytes::from_static(b"h3"), Bytes::from_static(b"v3"))
        .build();
    let flat = FlatMessage::new(msg).unwrap();
...
fn test_full_mqtt_message_roundtrip() {
    ...
    let msg = FlatMessageBuilder::new(Bytes::from(b"{\"temp\": 22.5}".to_vec()))
...
fn test_minimal_message_no_mqtt_fields() {
    ...
    let msg = FlatMessageBuilder::new(Bytes::from_static(b"x")).build();
    let flat = FlatMessage::new(msg).unwrap();
...
fn test_empty_value_with_mqtt_flags() {
    let msg = FlatMessageBuilder::new(Bytes::new())
        .timestamp(1000)
        .retain(true)
        .publisher_id(1)
        .build();
...
fn test_large_payload_with_mqtt_flags() {
    ...
    let msg = FlatMessageBuilder::new(large_payload.clone())
        .timestamp(1000)
        .retain(true)
        .publisher_id(u64::MAX)
        .routing_key(Bytes::from_static(b"large/topic"))
        .build();
    let flat = FlatMessage::new(msg).unwrap();
...
fn test_many_headers_with_mqtt_flags() {
    let mut builder = FlatMessageBuilder::new(Bytes::from_static(b"data"))
        .timestamp(1000)
        .retain(true)
        .publisher_id(42);
