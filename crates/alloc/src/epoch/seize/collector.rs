...
impl Collector {
    ...
    /// the [`Guard::protect`]. See the guide for an introduction to
    ...
    ///
    /// [`Guard::protect`]: super::Guard::protect
    ///
    /// # Performance
    ///
    ...
    /// use bisque_alloc::epoch::Guard;
    /// # let collector = bisque_alloc::epoch::Collector::new();
    ///
    /// // An atomic object.
    ...
    /// [`Guard::defer_retire`](super::Guard::defer_retire) if the pointer may
    ...
    /// # Examples
    ///
    /// Common reclaimers are provided by the [`reclaim`](super::reclaim)
    /// module.
    ///
    /// ```
    /// # use std::sync::atomic::{AtomicPtr, Ordering};
    /// # let collector = bisque_alloc::epoch::Collector::new();
    /// use bisque_alloc::epoch::reclaim;
    ///
    /// // An atomic object.
    /// let ptr = AtomicPtr::new(Box::into_raw(Box::new(1_usize)));
    ///
    ...
    ///
    /// ```
    /// use bisque_alloc::epoch::Collector;
    ///
