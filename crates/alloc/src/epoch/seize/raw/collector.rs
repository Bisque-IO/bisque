...
impl Collector {
    ...
    pub unsafe fn add<T>(
        &self,
        ptr: *mut T,
        reclaim: unsafe fn(*mut T, &crate::epoch::seize::collector::Collector),
        thread: Thread,
    ) {
        ...
        let reclaim: unsafe fn(*mut (), &crate::epoch::seize::collector::Collector) =
...
struct Entry {
    ...
    reclaim: unsafe fn(*mut (), &crate::epoch::seize::collector::Collector),
