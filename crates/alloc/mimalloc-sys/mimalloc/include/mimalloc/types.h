...
struct mi_heap_s {
  ...
  size_t                memory_limit;                        // maximum committed memory for this heap (0 = unlimited)
  _Atomic(intptr_t)     memory_usage;                        // current page memory attributed to this heap (in bytes, tracked at slice granularity)
  #endif
};
