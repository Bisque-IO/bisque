...
mi_decl_nodiscard mi_decl_export size_t mi_heap_get_memory_limit(mi_heap_t* heap);
mi_decl_nodiscard mi_decl_export size_t mi_heap_get_memory_usage(mi_heap_t* heap);
mi_decl_nodiscard mi_decl_export size_t mi_heap_memory_slice_size(void);
#endif
